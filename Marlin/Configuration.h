...
#define STRING_CONFIG_H_AUTHOR "(lsellens, M518 config)" // lsellens Original author or contributor.
...
#define Z_MIN_ENDSTOP_HIT_STATE LOW  // lsellens
...
//#define CLASSIC_JERK
  ...
  //#define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 40, 40, 0.8, 10 } // lsellens ...or, set your own edit limits
  #endif
#endif
...
#define Z_CLEARANCE_FOR_HOMING  4     // lsellens (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
