...
#define STRING_CONFIG_H_AUTHOR "(lsellens, MRiscoC)" // lsellens Original author or contributor.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_CREALITY_V24S1_301F4 // lsellens
#endif
 ...
 */
#define SERIAL_PORT 1 // lsellens
#define NO_AUTO_ASSIGN_WARNING  // lsellens
...
#define CUSTOM_MACHINE_NAME "Ender3S1-F4" // lsellens

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "d106addc-b75f-4348-9f7c-f64379d7dc0d" // lsellens
 ...
 */
#define X_DRIVER_TYPE  TMC2208_STANDALONE  // lsellens
#define Y_DRIVER_TYPE  TMC2208_STANDALONE  // lsellens
#define Z_DRIVER_TYPE  TMC2208_STANDALONE  // lsellens
...
#define E0_DRIVER_TYPE TMC2208_STANDALONE  // lsellens
...
#define HEATER_0_MINTEMP   0 // lsellens
...
#define BED_MAXTEMP      120 // lsellens
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  17.10 // lsellens
    #define DEFAULT_Ki   1.39 // lsellens
    #define DEFAULT_Kd  52.79 // lsellens
  #endif
#else
...
#define PIDTEMPBED // lsellens
  ...
  #define DEFAULT_bedKp 54.86  // lsellens
  #define DEFAULT_bedKi 10.06  // lsellens
  #define DEFAULT_bedKd 199.38 // lsellens
...
// @section pid temp
  ...
  #define PID_AUTOTUNE_MENU       // lsellens Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash)
#endif
...
#define EXTRUDE_MINTEMP 180 // lsellens
...
#define EXTRUDE_MAXLENGTH 25 // lsellens
...
//#define ENDSTOPPULLUPS // lsellens
#if DISABLED(ENDSTOPPULLUPS)
  // Disable ENDSTOPPULLUPS to set pullups individually
  //#define ENDSTOPPULLUP_XMIN
  //#define ENDSTOPPULLUP_YMIN
  #define ENDSTOPPULLUP_ZMIN // lsellens
  ...
  #define ENDSTOPPULLUP_ZMIN_PROBE // lsellens
#endif
 ...
 */
#define X_MIN_ENDSTOP_HIT_STATE LOW // lsellens
#define X_MAX_ENDSTOP_HIT_STATE HIGH
#define Y_MIN_ENDSTOP_HIT_STATE LOW // lsellens
...
#define ENDSTOP_INTERRUPTS_FEATURE // lsellens
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 424.9 } // lsellens
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 10, 45 } // lsellens

#define LIMITED_MAX_FR_EDITING        // lsellens Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 3000, 3000, 80, 200 } // lsellens ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 1000 } // lsellens

#define LIMITED_MAX_ACCEL_EDITING     // lsellens Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
 ...
 */
#define DEFAULT_ACCELERATION          500     // lsellens X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  800     // lsellens E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   1000    // lsellens X, Y, Z acceleration for travel (non printing) moves
 ...
 */
//#define CLASSIC_JERK // lsellens
#if ENABLED(CLASSIC_JERK)
  #define DEFAULT_XJERK  5.0 // lsellens
  #define DEFAULT_YJERK  5.0 // lsellens
  ...
  #define LIMITED_JERK_EDITING        // lsellens Limit edit via M205 or LCD to DEFAULT_aJERK * 2
  #if ENABLED(LIMITED_JERK_EDITING)
    #define MAX_JERK_EDIT_VALUES { 20, 20, 1, 20 } // lsellens ...or, set your own edit limits
  #endif
#endif
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.02  // lsellens (mm) Distance from real junction edge
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN // lsellens

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING // lsellens
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31.8, -40.5, 0 }  // lsellens
...
#define XY_PROBE_FEEDRATE (200*60) // lsellens

// Feedrate for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (16*60) // lsellens
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE    4 // lsellens (mm) Z Clearance for Deploy/Stow
#define Z_CLEARANCE_BETWEEN_PROBES  4 // lsellens (mm) Z Clearance between probe points
#define Z_CLEARANCE_MULTI_PROBE     4 // lsellens (mm) Z Clearance between multiple probes
#define Z_PROBE_ERROR_TOLERANCE     3 // (mm) Tolerance for early trigger (<= -probe.offset.z + ZPET)
//#define Z_AFTER_PROBING           5 // (mm) Z position after probing is done

#define Z_PROBE_LOW_POINT          -3 // lsellens (mm) Farthest distance below the trigger-point to go before stopping

// For M851 provide ranges for adjusting the X, Y, and Z probe offsets
#define PROBE_OFFSET_XMIN -50     // lsellens (mm)
#define PROBE_OFFSET_XMAX  50     // lsellens (mm)
#define PROBE_OFFSET_YMIN -50     // lsellens (mm)
#define PROBE_OFFSET_YMAX  50     // lsellens (mm)
//#define PROBE_OFFSET_ZMIN -20   // (mm)
//#define PROBE_OFFSET_ZMAX  20   // (mm)

// Enable the M48 repeatability test to test probe accuracy
#define Z_MIN_PROBE_REPEATABILITY_TEST // lsellens
...
#endif
#define PROBING_FANS_OFF            // lsellens Turn fans off when probing
//#define PROBING_ESTEPPERS_OFF     // Turn all extruder steppers off when probing
//#define PROBING_STEPPERS_OFF      // Turn all steppers off (unless needed to hold position) when probing (including extruders)
#define DELAY_BEFORE_PROBING 200    // lsellens (ms) To prevent vibrations from triggering piezo sensors
...
#define INVERT_Y_DIR false // lsellens
#define INVERT_Z_DIR true  // lsellens
...
#define NO_MOTION_BEFORE_HOMING   // lsellens Inhibit movement until all axes have been homed. Also enable HOME_AFTER_DEACTIVATE for extra safety.
#define HOME_AFTER_DEACTIVATE     // lsellens Require rehoming after steppers are deactivated. Also enable NO_MOTION_BEFORE_HOMING for extra safety.
...
#define X_BED_SIZE 220 // lsellens
#define Y_BED_SIZE 220 // lsellens

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -10  // lsellens
#define Y_MIN_POS -8   // lsellens
#define Z_MIN_POS 0    // lsellens
#define X_MAX_POS 230  // lsellens
#define Y_MAX_POS 230  // lsellens
#define Z_MAX_POS 270  // lsellens
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
 ...
 */
#define FILAMENT_RUNOUT_SENSOR            // lsellens
#if ENABLED(FILAMENT_RUNOUT_SENSOR)
  #define FIL_RUNOUT_ENABLED_DEFAULT true // Enable the sensor on startup. Override with M412 followed by M500.
  #define NUM_RUNOUT_SENSORS   1          // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.

  #define FIL_RUNOUT_STATE     HIGH       // lsellens Pin state indicating that filament is NOT present.
  //#define FIL_RUNOUT_PULLUP             // lsellens Use internal pullup for filament runout pins.
  #define FIL_RUNOUT_PULLDOWN             // lsellens Use internal pulldown for filament runout pins.
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 300 // lsellens
...
#define AUTO_BED_LEVELING_UBL  // lsellens
 ...
 */
#define PREHEAT_BEFORE_LEVELING      // lsellens
#if ENABLED(PREHEAT_BEFORE_LEVELING)
  #define LEVELING_NOZZLE_TEMP   0   // lsellens (°C) Only applies to E0 at this time
  #define LEVELING_BED_TEMP     60   // lsellens
#endif
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 35             // lsellens Set Mesh bounds as an inset region of the bed
  #define GRID_MAX_POINTS_X 9       // lsellens Don't use more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X

  #define UBL_HILBERT_CURVE         // lsellens Use Hilbert distribution for less travel when probing multiple points

  #define UBL_TILT_ON_MESH_POINTS           // lsellens Use nearest mesh points with G29 J for better Z reference
  #define UBL_TILT_ON_MESH_POINTS_3POINT    // lsellens Use nearest mesh points with G29 J0 (3-point)

  #define UBL_MESH_EDIT_MOVES_Z     // Sophisticated users prefer no movement of nozzle
  //#define UBL_SAVE_ACTIVE_ON_M500 // lsellens Save the currently active mesh in the current slot on M500
...
#define LCD_BED_TRAMMING // lsellens

#if ENABLED(LCD_BED_TRAMMING)
  #define BED_TRAMMING_INSET_LFRB { 35, 35, 35, 35 } // lsellens (mm) Left, Front, Right, Back insets
  #define BED_TRAMMING_HEIGHT      0.0        // (mm) Z height of nozzle at tramming points
  #define BED_TRAMMING_Z_HOP       4.0        // (mm) Z raise between tramming points
  //#define BED_TRAMMING_INCLUDE_CENTER       // Move to the center after the last corner
  #define BED_TRAMMING_USE_PROBE // lsellens
  #if ENABLED(BED_TRAMMING_USE_PROBE)
    #define BED_TRAMMING_PROBE_TOLERANCE 0.05 // lsellens (mm)
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (10*60) } // lsellens
 ...
 */
#define EEPROM_SETTINGS       // lsellens Persistent storage with M500 and M501
//#define DISABLE_M503        // Saves ~2700 bytes of flash. Disable for release!
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save flash.
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
#if ENABLED(EEPROM_SETTINGS)
  //#define EEPROM_AUTO_INIT  // Init EEPROM automatically on any errors.
  #define EEPROM_INIT_NOW     // lsellens Init EEPROM on first boot after a new build.
#endif
...
//
#define PREHEAT_1_LABEL       "PLA" // lsellens
#define PREHEAT_1_TEMP_HOTEND  195  // lsellens
#define PREHEAT_1_TEMP_BED      60  // lsellens
#define PREHEAT_1_TEMP_CHAMBER  35  // lsellens
#define PREHEAT_1_FAN_SPEED      0  // lsellens

#define PREHEAT_2_LABEL      "PETG" // lsellens
#define PREHEAT_2_TEMP_HOTEND  230  // lsellens
#define PREHEAT_2_TEMP_BED      80  // lsellens
#define PREHEAT_2_TEMP_CHAMBER  35  // lsellens
#define PREHEAT_2_FAN_SPEED      0  // lsellens

#define PREHEAT_3_LABEL       "TPU" // lsellens
#define PREHEAT_3_TEMP_HOTEND  220  // lsellens
#define PREHEAT_3_TEMP_BED      60  // lsellens
#define PREHEAT_3_TEMP_CHAMBER  35  // lsellens
#define PREHEAT_3_FAN_SPEED      0  // lsellens

#define PREHEAT_4_LABEL    "CUSTOM" // lsellens
#define PREHEAT_4_TEMP_HOTEND  150  // lsellens
#define PREHEAT_4_TEMP_BED      60  // lsellens
#define PREHEAT_4_TEMP_CHAMBER  35  // lsellens
#define PREHEAT_4_FAN_SPEED      0  // lsellens
 ...
 */
#define NOZZLE_PARK_FEATURE // lsellens

#if ENABLED(NOZZLE_PARK_FEATURE)
  // Specify a park position as { X, Y, Z_raise }
  #define NOZZLE_PARK_POINT { (X_MIN_POS), (Y_MAX_POS - 12), 20 } // lsellens
...
//
#define ENCODER_PULSES_PER_STEP 4 // lsellens

//
// Use this option to override the number of step signals required to
// move between next/prev menu items.
//
#define ENCODER_STEPS_PER_MENU_ITEM 1 // lsellens
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 2 // lsellens
#define LCD_FEEDBACK_FREQUENCY_HZ 5000       // lsellens
...
//#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN               PA13 // lsellens LED driving pin
