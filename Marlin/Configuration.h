...
#define STRING_CONFIG_H_AUTHOR "(lsellens, M518 config)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MKS_SMELZI_10 // lsellens
#endif
...
#define CUSTOM_MACHINE_NAME "Alunar M518" // lsellens

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "13d113cd-a782-47b5-8115-7a0e02c750c0" // lsellens
 ...
 */
#define PSU_CONTROL // lsellens
#define PSU_NAME "Power Supply" // lsellens
  ...
  #define PSU_DEFAULT_OFF               // lsellens Keep power off until enabled directly with M80
  ...
  #define AUTO_POWER_CONTROL      // lsellens Enable automatic control of the PS_ON pin
    ...
    #define AUTO_POWER_E_TEMP        50 // lsellens (°C) PSU on if any extruder is over this temperature
...
#define TEMP_SENSOR_BED 0 // lsellens no heated bed
...
#define HEATER_0_MAXTEMP 270 // lsellens
...
#define BED_MAXTEMP      115 // lsellens
...
#define Z_MIN_ENDSTOP_INVERTING true  // lsellens Set to true to invert the logic of the endstop.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100.23, 100.25, 400.60, 96.00 } // lsellens
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 5, 25 } // lsellens

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 300, 300, 10, 50 } // lsellens ...or, set your own edit limits
#endif
...
//#define CLASSIC_JERK
  ...
  #define DEFAULT_XJERK 20.0 // lsellens
  #define DEFAULT_YJERK 20.0 // lsellens
  #define DEFAULT_ZJERK  0.4 // lsellens
  ...
  //#define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 40, 40, 0.8, 20 } // lsellens ...or, set your own edit limits
  #endif
#endif
...
#define INVERT_X_DIR true // lsellens
...
#define INVERT_E0_DIR true // lsellens
...
#define Z_HOMING_HEIGHT  4      // lsellens (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
...
#define X_BED_SIZE 155 // lsellens
#define Y_BED_SIZE 150 // lsellens

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -20 // lsellens
#define Y_MIN_POS -25 // lsellens
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE
#define Y_MAX_POS Y_BED_SIZE
#define Z_MAX_POS 160 // lsellens
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define LCD_BED_TRAMMING // lsellens
  ...
  #define BED_TRAMMING_INSET_LFRB { 0, 0, 0, 0 } // lsellens (mm) Left, Front, Right, Back insets
  #define BED_TRAMMING_HEIGHT      0.0        // (mm) Z height of nozzle at tramming points
  #define BED_TRAMMING_Z_HOP       4.0        // (mm) Z height of nozzle between tramming points
  #define BED_TRAMMING_INCLUDE_CENTER       // lsellens Move to the center after the last corner
...
#define PREHEAT_1_TEMP_BED     50 // lsellens
...
#define NOZZLE_PARK_FEATURE // lsellens
  ...
  // Specify a park position as { X, Y, Z_raise }
    #define NOZZLE_PARK_POINT { (X_MIN_POS), (Y_MAX_POS), 20 } // lsellens
 ...
 */
//#define NO_LCD_MENUS
#define SLIM_LCD_MENUS // lsellens
...
//
#define MKS_MINI_12864 // lsellens
